...
I'll be sharing my progress periodically, and I'll escslate this post to an article once  finished (maybe it'll turn out as a shining demonstration of sucess, or maybe it'll end up as a dismal example of failure; we'll have to wait and see 😬). Now... where did I put that blowtorch?
