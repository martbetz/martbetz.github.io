...
To measure the balls apcorrectly, you’ll need to use a <a href="https://en.m.wikipedia.org/wiki/Calipers#Vernier_caliper">calliper</a> (please provide a photo where possible). Please don’t send me estimates&nbsp;— <i>we’re talking small tolerances, here, so estimates are as useful as an ashtray on a motorbike!</i>
