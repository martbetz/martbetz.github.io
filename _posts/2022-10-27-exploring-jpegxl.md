...
The **J**oint **P**hotographic **E**xprts **G**roup **X** **L**ong-Term format (_WTF?!_ 🤢) brings _a lot_ of new features to the table: support for wide colour gamuts and high bit-depths, alpha channel (transparency) and multi-layer image (animation) support, significantly improved lossy _and_ lossless file compression, and advanced progressive decoding.
