...
If you've never heard of [xpano](https://github.com/krupkat/xpano) before, you're completely excused; it hasn't been around that long at all; in fact, it was only a few weeks ago that it was discovered on GitHub and introduced on the pixls.us forum. 

Panoramic images aren't too common in street photography (maybe we could change that? 🤔), so I haven't used xpano that much myself; judging by the general feedback, though, it's certainly gaining kudos from some early adopters.
