...
¹ We're currently in the process of putting a [PKGBUILD](https://wiki.archlinux.org/title/PKGBUILD)  together, but we're having a bit of trouble getting it to work (I'm not very experienced with this sort of stuff, so I'm about as useful as an ashtray on a motorbike 😒). If you could offer any help at all, please give us a shout.
