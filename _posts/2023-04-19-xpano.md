...
UPDATE: Thanks to [Sebastian Guyader](https://discuss.pixls.us/u/sguyader/summary), we now have a working [xpano PKGBUILD](https://bbs.archlinux.org/viewtopic.php?id=285253); however, we still need help ([Github issue #85](https://github.com/krupkat/xpano/issues/85)). I'm happy to step up as the maintainer when (if) we're able to get it submitted to the AUR.
