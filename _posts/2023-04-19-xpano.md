...
UPDATE: Thanks to [Sebastian Guyader](https://discuss.pixls.us/u/sguyader/summary), we now have a working [xpano PKGBUILD](https://bbs.archlinux.org/viewtopic.php?id=285253); however, we still need some assistance getting ready for the AUR ([Github issue #85](https://github.com/krupkat/xpano/issues/85)).
