...
UPDATE: Thanks to all the hard work of [Sebastian Guyader](https://discuss.pixls.us/u/sguyader/summary), we now have a working [xpano PKGBUILD](https://bbs.archlinux.org/viewtopic.php?id=285253); however, we still need a some assistance before we can uploaded it to the AUR ([Github issue #85](https://github.com/krupkat/xpano/issues/85)).
