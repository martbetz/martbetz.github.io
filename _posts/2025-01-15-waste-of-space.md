...
As it turned out, I decided not to compress any raw files; it all came in at around 400 GB, which is very workable for now. What I’ve decided to do instead is manage it all with <a href="https://www.kphotoalbum.org/">KPhotoAlbum</a>; it’s all set up, and I have a plan. 😁
