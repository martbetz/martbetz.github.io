...
I've just added a further two lenses to the repo, so we've now hit double figures!🍻 There seems to be two distinct versions of the Auto-Promura 28mm C.P. Hi-Lux MC floating around: one with a 49mm filter thread, and one with a 55mm filter thread — perhaps they are made by different manufacturers?
