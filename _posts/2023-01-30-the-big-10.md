...
I've just added a further two lenses to the repo, so we've now hit double figures!🍻 Curiously, there seems to be two distinct versions of the Promura 28mm floating around: one with a 49mm filter thread, and one with a 55mm filter thread — perhaps they are made by different manufacturers?
