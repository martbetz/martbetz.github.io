...
So that's most definately that, then, or so it apparently seems; [attempt to connect with Ello](https://www.ello.co), and you'll be served the charming mid digit (a Cloudflare DNS error, at the current time of writing). 
