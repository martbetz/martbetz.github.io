...
<ul>
<li>
(as per the <a href="#copyright">Intellectual Property Notice</a>) the title (“JPEG Junkie”), subtitle (“An Affliction of Addiction to Obsessive Observation and Perfective Presentation Portrayed!”) and logo (<img src="/favicon.ico" alt="logo" width="16px">) are the trademark (ᴛᴍ) of the author
</li>
</ul>
<ul>
<li>
...
<p>
The title (“JPEG Junkie”), subtitle (“An Affliction of Addiction to Obsessive Observation and Perfective Presentation Portrayed!”) and logo (<img src="/favicon.ico" alt="logo" width="16px">) are the trademark (ᴛᴍ) of the author.
     </p> 
 </div>
<hr>
<div id="privacy"> 
