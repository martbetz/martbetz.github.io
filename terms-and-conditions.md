...
<br>
<br>
This website is hosted by <a href="https://pages.github.com">GitHub Pages</a>; it was built using <a href="https://jekyllrb.com">Jekyll</a> and incorporates a fork of the <a href="https://jekyll.github.io/minima/about/">Minima</a> theme. Images attributed to the author are hosted by both <a href="github.com">GitHub</a> (as 'user content') and <a href="https:/ello.co">Ello</a>; images that are not attributed to the author may be hosted by other external websites. The source code for this website is is also hosted by GitHub and is available for public audit.
<hr>
<ol>
   <li>
