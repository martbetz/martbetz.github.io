...
<ul>
<li>
(as per the <a href="#privacy">Privacy Policy</a>) images attributed to the author are hosted by GitHub (as 'user content') and <a href="https:/ello.co">Ello</a>; however, the author reserves the right to also use images that are hosted by other sites
</li>
</ul>
    </p>
 </div> 
...
<br>
<br>
Images attributed to the author are hosted by GitHub (as 'user content') and <a href="https:/ello.co">Ello</a>; however, the author reserves the right to also use images that are hosted by other sites.
